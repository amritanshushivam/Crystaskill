          ...
          <div className="col-span-2 sm:col-span-2 lg:col-span-4 space-y-4 sm:space-y-6">
            ...
            <div className="flex items-center gap-2">
              {[
                ...
                { icon: Instagram, href: "https://www.instagram.com/crystaskill_edutech_pvt.ltd/" },
              ].map((social, idx) => (
                <Link
                  key={idx}
                  href={social.href}
            ...
            <div className="flex sm:flex-col gap-4 sm:gap-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@crystaskill.com" className="text-[13px] font-medium text-primary/80 hover:text-accent transition-colors">
                    info@crystaskill.com
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+917428735663" className="text-[13px] font-medium text-primary/80 hover:text-accent transition-colors">+91 74287 35663</a>
                </div>
              </div>
            </div>
          </div>
