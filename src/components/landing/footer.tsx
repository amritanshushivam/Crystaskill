            ...
            <div className="flex sm:flex-col gap-4 sm:gap-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:support@crystaskill.com" className="text-[13px] font-medium text-primary/80 hover:text-accent transition-colors">
                    support@crystaskill.com
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <p className="text-[10px] font-semibold text-primary/50 uppercase tracking-wider">Phone</p>
                  <a href="tel:+917545912663" className="text-[13px] font-medium text-primary/80 hover:text-accent transition-colors whitespace-nowrap">
                    +917545912663
                  </a>
                </div>
              </div>
