...
import { Menu, ChevronDown, Rocket, ShieldCheck, Users, Briefcase, GraduationCap, Globe, Laptop, ArrowUpRight, X } from "@/lib/icons"
...
const navData = [
  ...
  },
  {
    ...
    href: "#contact",
    items: [
      { title: "Apply Now", desc: "50 seats. We're selective.", icon: Rocket, link: "/enrollment-policy" },
